...
Then, create the data base \texttt{shinemas\_tuto}:
...
Once you've done this, download the \texttt{shinemas\_tuto.sql} here: \url{TODO!}, put in your \texttt{/home/pierre} for example, and install it on postgresql.
...
You can look at the databse you have:
\begin{verbatim}
sudo -i -u postgres
postgres@RSP:~$ psql -l
\end{verbatim}
...
More information on posgresql can be found here: \url{help.ubuntu.com/community/PostgreSQL}
